...
const SimpleSlider = () => {
  ...
  return (
    <Slider {...settings}>
      <div>
        <Image
          src="/images/slider/slider1_img1.jpeg"
          alt="photo tournage"
          width={900}
          height={400}
      ...
      <div>
        <Image
          src="/images/slider/slider1_img2.jpeg"
          alt="photo tournage"
          width={900}
          height={400}
          className={styles.image_slider_cinema}
      ...
      <div>
        <Image
          src="/images/slider/slider1_img3.jpeg"
          alt="photo tournage"
          width={900}
          height={400}
          className={styles.image_slider_cinema}
      ...
      <div>
        <Image
          src="/images/slider/slider1_img4.jpeg"
          alt="photo tournage"
          width={900}
          height={400}
          className={styles.image_slider_cinema}
      ...
      <div>
        <Image
          src="/images/slider/slider1_img5.jpeg"
          alt="photo tournage"
          width={900}
          height={400}
          className={styles.image_slider_cinema}
