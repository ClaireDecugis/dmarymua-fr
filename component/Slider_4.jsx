...
const SimpleSlider_4 = () => {
  ...
  const settings = {
    ...
    responsive: [
      ...
      },
      {
        breakpoint: 1025,
        settings: {
          appendDots: (dots) => <ul style={{ bottom: "34px" }}> {dots} </ul>,
        },
      },
    ],
  };
  ...
  return (
    <Slider {...settings}>
      <div>
        <Image
          src="/images/slider/slider4_img1.jpeg"
          alt="photo tournage"
          width={900}
          height={400}
      ...
      <div>
        <Image
          src="/images/slider/slider4_img2.jpeg"
          alt="photo tournage"
          width={900}
          height={400}
          className={styles.image_slider_cinema}
      ...
      <div>
        <Image
          src="/images/slider/slider4_img3.jpeg"
          alt="photo tournage"
          width={900}
          height={400}
          className={styles.image_slider_cinema}
      ...
      <div>
        <Image
          src="/images/slider/slider4_img4.jpeg"
          alt="photo tournage"
          width={900}
          height={400}
          className={styles.image_slider_cinema}
      ...
      <div>
        <Image
          src="/images/slider/slider4_img5.jpeg"
          alt="photo tournage"
          width={900}
          height={400}
          className={styles.image_slider_cinema}
