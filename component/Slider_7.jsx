...
const SimpleSlider_7 = () => {
  ...
  return (
    <Slider {...settings}>
      <div>
        <Image
          src="/images/slider/slider7_img1.jpeg"
          alt="photo tournage"
          width={900}
          height={400}
      ...
      <div>
        <Image
          src="/images/slider/slider7_img2.jpeg"
          alt="photo tournage"
          width={900}
          height={400}
          className={styles.image_slider_cinema}
      ...
      <div>
        <Image
          src="/images/slider/slider7_img3.jpeg"
          alt="photo tournage"
          width={900}
          height={400}
          className={styles.image_slider_cinema}
      ...
      <div>
        <Image
          src="/images/slider/slider7_img4.jpeg"
          alt="photo tournage"
          width={900}
          height={400}
          className={styles.image_slider_cinema}
      ...
      <div>
        <Image
          src="/images/slider/slider7_img5.jpeg"
          alt="photo tournage"
          width={900}
          height={400}
          className={styles.image_slider_cinema}
