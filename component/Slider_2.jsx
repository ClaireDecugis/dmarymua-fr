...
const SimpleSlider_2 = () => {
    ...
    responsive: [
      {
        breakpoint: 330,
        settings: {
          appendDots: (dots) => <ul style={{ bottom: "9px" }}>{dots}</ul>,
        },
      },
      {
        breakpoint: 480,
  ...
  return (
    <Slider {...settings}>
      <div>
        <Image
          src="/images/slider/slider2_img1.jpeg"
          alt="photo tournage"
          width={900}
          height={400}
      ...
      <div>
        <Image
          src="/images/slider/slider2_img2.jpeg"
          alt="photo tournage"
          width={900}
          height={400}
          className={styles.image_slider_cinema}
      ...
      <div>
        <Image
          src="/images/slider/slider2_img3.jpeg"
          alt="photo tournage"
          width={900}
          height={400}
          className={styles.image_slider_cinema}
      ...
      <div>
        <Image
          src="/images/slider/slider2_img4.jpeg"
          alt="photo tournage"
          width={900}
          height={400}
          className={styles.image_slider_cinema}
