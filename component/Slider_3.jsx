...
const SimpleSlider_3 = () => {
  ...
  const settings = {
    ...
    responsive: [
      ...
      },
      {
        breakpoint: 769,
        settings: {
          appendDots: (dots) => <ul style={{ bottom: "3px" }}>{dots}</ul>,
        },
      },
      {
        breakpoint: 1025,
  ...
  return (
    <Slider {...settings}>
      <div>
        <Image
          src="/images/slider/slider3_img1.jpeg"
          alt="photo tournage"
          width={900}
          height={400}
      ...
      <div>
        <Image
          src="/images/slider/slider3_img2.jpeg"
          alt="photo tournage"
          width={900}
          height={400}
          className={styles.image_slider_cinema}
      ...
      <div>
        <Image
          src="/images/slider/slider3_img3.jpeg"
          alt="photo tournage"
          width={900}
          height={400}
          className={styles.image_slider_cinema}
      ...
      <div>
        <Image
          src="/images/slider/slider3_img4.jpeg"
          alt="photo tournage"
          width={900}
          height={400}
          className={styles.image_slider_cinema}
      ...
      <div>
        <Image
          src="/images/slider/slider3_img5.jpeg"
          alt="photo tournage"
          width={900}
          height={400}
          className={styles.image_slider_cinema}
      ...
      <div>
        <Image
          src="/images/slider/slider3_img6.jpeg"
          alt="photo tournage"
          width={900}
          height={400}
          className={styles.image_slider_cinema}
